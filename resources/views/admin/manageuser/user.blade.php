                        ...
                        <div class="table-responsive">
                            ...
                            <table  class="display table table-striped table-hover basic-datatables">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="#">{{ $branch->name }}({{$branch->branch_code}})</a>
                                                </li>
                                                @endforeach
                                            </ul>
                                            @else
                                        ...
                                        <td>
                                            ...
                                            <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                data-bs-custom-class="custom-tooltip"
                                                data-bs-title="Assign Branch">
                                                <button class="btn btn-success btn-link btn-lg" data-bs-toggle="modal"
                                                data-bs-target="#branch_assign_modal-{{ $user->id }}">
                                    ...
                                    @include('admin.manageuser.assign_branch')
...
<script>
    $(document).ready(function () {
        $(document).on('shown.bs.modal', '[id^=branch_assign_modal-]', function () {
            $(this).find('.dept-Select2').select2({
                theme: "bootstrap",
                placeholder: "--Select--",
                width: "100%",
