                ...
                <div class="text-white p-4" style="background: linear-gradient(to bottom, #6861ce, #EFBBFF);">
                    <div class="row align-items-center g-4" style="padding-top: 50px;">
                        ...
                        <div class="col-auto position-relative">
                            ...
                            <!-- Form -->
                            <form method="POST" id="uploadForm" action="{{route('employee.document.store')}}" enctype="multipart/form-data">
                                @csrf
                    ...
                    <div class="d-flex profile-wrapper " style="margin: 20px 20px;">
                        ...
                        <ul class="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link fs-14" data-bs-toggle="tab" href="#history" role="tab">
                                    <i class="ri-folder-4-line d-inline-block d-md-none"></i> <span
                                        class="d-none d-md-inline-block ">History</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="flex-shrink-0 ms-2">
                            <a href="{{ route('employee.download.profile', $employeePersonal->id) }}" class="btn btn-warning"><i
                                                        ...
                                                        <table class="table table-borderless mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-muted">
                                                                        {{$employeePersonal->officialInformation ?
                                                                        $employeePersonal->officialInformation->branch
                                                                        ? $employeePersonal->officialInformation->branch->name: "N/A": "N/A"}}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th class="ps-0" scope="row">Employee Type:</th>
                                                                    <td class="text-muted">
                                                                        {{$employeePersonal->officialInformation ? $employeePersonal->officialInformation->employeeType ? $employeePersonal->officialInformation->employeeType->name: "N/A": "N/A"}}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th class="ps-0" scope="row">Grade:</th>
                                                                    <td class="text-muted">
                                                                        {{$employeePersonal->officialInformation ? $employeePersonal->officialInformation->employeeGrade ? $employeePersonal->officialInformation->employeeGrade->name: "N/A" : "N/A"}}
                                                                    </td>
                                                                </tr>
                                                                @if ($employeePersonal->officialInformation != null && $employeePersonal->officialInformation->reportingfirst != null)
                                                                <tr>
                                                                    <th class="ps-0" scope="row">Reporting To (First):</th>
                                                                    <td class="text-muted">
                                                                        {{$employeePersonal->officialInformation ? $employeePersonal->officialInformation->reportingfirst ? $employeePersonal->officialInformation->reportingfirst->salutations? $employeePersonal->officialInformation->reportingfirst->salutations->name: "" : "" : " "}} {{$employeePersonal->officialInformation ? $employeePersonal->officialInformation->reportingfirst ? $employeePersonal->officialInformation->reportingfirst->first_name:"":"" }} {{$employeePersonal->officialInformation ? $employeePersonal->officialInformation->reportingfirst ? $employeePersonal->officialInformation->reportingfirst->last_name:"":""}}</td>
                                                                </tr>
                                                                @endif
                                                                @if ($employeePersonal->officialInformation != null && $employeePersonal->officialInformation->reportingsecond != null)
                                                                <tr>
                                                                ...
                                                                @endif
                                                                @if ($employeePersonal->officialInformation != null && $employeePersonal->officialInformation->reportingthird != null)
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-muted">
                                                                        {{$employeePersonal->officialInformation ? $employeePersonal->officialInformation->notice_start_date ? \Carbon\Carbon::parse($employeePersonal->officialInformation->notice_start_date)->format('d M Y') : '' :''}}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th class="ps-0" scope="row">Notice Period End Date:</th>
                                                                    <td class="text-muted">
                                                                        {{$employeePersonal->officialInformation ? $employeePersonal->officialInformation->notice_end_date ? \Carbon\Carbon::parse($employeePersonal->officialInformation->notice_end_date)->format('d M Y') : '':'' }}
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                                        ...
                                                                                        <div class="card shadow-sm">
                                                                                            ...
                                                                                            <div class="card-body">
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-7">{{$employeeReference->reference_occupation ?? ""}}</div>
                                                                                                </div>
                                                                                                <div class="row">
                                                                                                    <div class="col-5"><strong>Relation:</strong></div>
                                                                                                    <div class="col-7">{{$employeeReference->relations ? $employeeReference->relations->name:'N/A'}}</div>
                                                                                                </div>
                                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-6 col-lg-6">
                                                                                        <div class="card shadow-sm">
                                                                                            ...
                                                                                            <div class="card-body">
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    <div class="col-5"><strong>Occupation:</strong></div>
                                                                                                    <div class="col-7">{{$employeeGranter->granter_occupation ?? ""}}</div>
                                                                                                </div>
                                                                                                <div class="row">
                                                                                                    <div class="col-5"><strong>Relation:</strong></div>
                                                                                                    <div class="col-7">{{$employeeGranter->relations?$employeeGranter->relations->name:'N/A'}}</div>
                                                                                                </div>
                                                                                                <div class="row">
                                                                                                    <div class="col-5"><strong>Contact Number:</strong></div>
                                                                                                    <div class="col-7">
                                            ...
                                            <div class="d-flex align-items-center mb-4">
                                                ...
                                                <div class="flex-shrink-0">
                                                    @can('Update Employee')
                                                        ...
                                                        <button class="btn btn-primary btn-xxl" data-bs-toggle="modal" data-bs-target="#add-documents-{{$employeePersonal->id}}">
                                                        <i class='bx bx-cloud-download bx-flashing me-1' ></i> Uploads</button>
                                                        </span>
                                                    @endcan
                                                        @php
                                                            $hasDocuments = false;
                                                        ...
                                                        @if ($hasDocuments)
                                                            <a class="btn btn-danger" href="{{ route('employee.downloadzip.file', $employeePersonal->id) }}">Download All Files</a>
                                                        @endif
                                                </div>
                                            </div>
                                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="card">
                                                        <div class="card-header align-items-center d-flex">
                                                            <h4 class="card-title mb-0  me-2">Transfers</h4>

                                                        </div>
                                                        <div class="card-body">
                                                            <div class="tab-content text-muted">
                                                                @foreach ($employeetransfers as $employeetransfer)
                                                                ...
                                                                <div class="container py-2">
                                                                    <div class="row justify-content-center align-items-stretch g-2">
                                                                      ...
                                                                      <div class="col-md-5">
                                                                        <div class="card border-0 shadow-sm h-100">
                                                                          <div class="card-header bg-primary bg-gradient text-white fw-semibold">
                                                                            Old Branch ({{ $employeetransfer->oldBranch ? $employeetransfer->oldBranch->name : "N/A" }})
                                                                          </div>
                                                                          <div class="card-body">
                                                                            <p class="mb-1"><strong>Branch Name:</strong> {{ $employeetransfer->oldBranch ? $employeetransfer->oldBranch->name : "N/A" }}</p>
                                                                            <p class="mb-1"><strong>Designation:</strong> {{ $employeetransfer->oldDesignation ? $employeetransfer->oldDesignation->designation_name : "N/A" }}</p>
                                                                            <p class="mb-1"><strong>Department:</strong> {{ $employeetransfer->oldDepartment ? $employeetransfer->oldDepartment->department_name : "N/A" }}</p>
                                                                            <p class="mb-1"><strong>Reporting To:</strong></p>
                                                                            <ul class="list-unstyled ps-3">
                                                                              @if ($employeetransfer->oldReportingfirst)
                                                                                <li><i class="bx bx-user-voice"></i>{{ $employeetransfer->oldReportingfirst->first_name }} {{ $employeetransfer->oldReportingfirst->last_name }}</li>
                                                                              @endif
                                                                              @if ($employeetransfer->oldReportingsecond)
                                                                                <li><i class="bx bx-user-voice"></i>{{ $employeetransfer->oldReportingsecond->first_name }} {{ $employeetransfer->oldReportingsecond->last_name }}</li>
                                                                              @endif
                                                                              @if ($employeetransfer->oldReportingthird)
                                                                                <li><i class="bx bx-user-voice"></i>{{ $employeetransfer->oldReportingthird->first_name }} {{ $employeetransfer->oldReportingthird->last_name }}</li>
                                                                              @endif
                                                                            </ul>
                                                                          </div>
                                                                        </div>
                                                                      ...
                                                                      <div class="col-md-5">
                                                                        <div class="card border-0 shadow-sm h-100">
                                                                          <div class="card-header bg-success bg-gradient text-white fw-semibold d-flex justify-content-between align-items-center">
                                                                            <span>New Branch ({{ $employeetransfer->newBranch ? $employeetransfer->newBranch->name : "N/A" }})</span>
                                                                            <small class="fw-light">Reporting Date: {{ $employeetransfer->reporting_date ? \Carbon\Carbon::parse($employeetransfer->reporting_date)->format('d M Y') : 'N/A' }}</small>
                                                                          </div>
                                                                          <div class="card-body">
                                                                            <p class="mb-1"><strong>Branch Name:</strong> {{ $employeetransfer->newBranch ? $employeetransfer->newBranch->name : "N/A" }}</p>
                                                                            <p class="mb-1"><strong>Designation:</strong> {{ $employeetransfer->newDesignation ? $employeetransfer->newDesignation->designation_name : "N/A" }}</p>
                                                                            <p class="mb-1"><strong>Department:</strong> {{ $employeetransfer->newDepartment ? $employeetransfer->newDepartment->department_name : "N/A" }}</p>
                                                                            <p class="mb-1"><strong>Reporting To:</strong></p>
                                                                            <ul class="list-unstyled ps-3">
                                                                              @if ($employeetransfer->newReportingfirst)
                                                                                <li><i class="bx bx-user-voice"></i>{{ $employeetransfer->newReportingfirst->first_name }} {{ $employeetransfer->newReportingfirst->last_name }}</li>
                                                                              @endif
                                                                              @if ($employeetransfer->newReportingsecond)
                                                                                <li><i class="bx bx-user-voice"></i>{{ $employeetransfer->newReportingsecond->first_name }} {{ $employeetransfer->newReportingsecond->last_name }}</li>
                                                                              @endif
                                                                              @if ($employeetransfer->newReportingthird)
                                                                                <li><i class="bx bx-user-voice"></i>{{ $employeetransfer->newReportingthird->first_name }} {{ $employeetransfer->newReportingthird->last_name }}</li>
                                                                              @endif
                                                                            </ul>
                                                                          </div>
                                                                        </div>
...
<div class="modal fade bs-example-modal-center" id="add-documents-{{$employeePersonal->id}}" tabindex="-1"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{route('employee.document.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        @if ($employeedocument = $employeedocuments->where('employee_id', $employeePersonal->id)->first())
                        @php
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <label for="profile_picture_{{$employeePersonal->id}}">
                                    @php
                                    ...
                                    <img src="{{ $profilePicturePreview }}" alt="Profile Picture" class="img-thumbnail"
                                        id="profile_picture_file_{{$employeePersonal->id}}" style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input"
                                        id="profile_picture_{{$employeePersonal->id}}" name="profile_picture"
                                        style="display: none;" />
                                    <div id="profile_picture_file_{{$employeePersonal->id}}_name">
                                        <p
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="signature_{{$employeePersonal->id}}">
                                    @php
                                    ...
                                    <img src="{{ $signaturePreview }}" alt="Signature" class="img-thumbnail"
                                        id="signature_file_{{$employeePersonal->id}}" style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input"
                                        id="signature_{{$employeePersonal->id}}" name="signature" style="display: none;" />
                                    <div id="signature_file_{{$employeePersonal->id}}_name">
                                        <p
                                            style="width:100%; word-wrap:break-word; white-space:normal; font-size: 10px;">
                                            {{$signatureFileName}}</p>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="nid_card_front_{{$employeePersonal->id}}">
                                    @php
                                    ...
                                    <img src="{{ $nidCardPreview }}" alt="NID Card" class="img-thumbnail"
                                        id="nid_card_front_file_{{$employeePersonal->id}}" style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input" id="nid_card_front_{{$employeePersonal->id}}"
                                        name="nid_card_front" style="display: none;" />
                                    <div id="nid_card_front_file_{{$employeePersonal->id}}_name">
                                        <p
                                            style="width:100%; word-wrap:break-word; white-space:normal; font-size: 10px;">
                                            {{$nidCardFileName}}</p>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="nid_card_back_{{$employeePersonal->id}}">
                                    @php
                                    ...
                                    @endphp
                                    <img src="{{ $nidCardPreview }}" alt="NID Card" class="img-thumbnail"
                                        id="nid_card_back_file_{{$employeePersonal->id}}" style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input" id="nid_card_back_{{$employeePersonal->id}}"
                                        name="nid_card_back" style="display: none;" />
                                    <div id="nid_card_back_file_{{$employeePersonal->id}}_name">
                                        <p
                                            style="width:100%; word-wrap:break-word; white-space:normal; font-size: 10px;">
                                            {{$nidCardFileName}}</p>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>CV</label>
                                <label for="cv_{{$employeePersonal->id}}">
                                    @php
                                    ...
                                    <img src="{{ $cvPreview }}" alt="cv" class="img-thumbnail"
                                        id="cv_file_{{$employeePersonal->id}}" style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input" id="cv_{{$employeePersonal->id}}"
                                        name="cv" style="display: none;" />
                                    <div id="cv_file_{{$employeePersonal->id}}_name">
                                        <p
                                            style="width:100%; word-wrap:break-word; white-space:normal; font-size: 10px;">
                                            {{$cvFileName}}</p>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="trade_licence_{{$employeePersonal->id}}">
                                    @php
                                    ...
                                    <img src="{{ $trade_licencePreview }}" alt="Trade Licence"
                                        class="img-thumbnail" id="trade_licence_file_{{$employeePersonal->id}}"
                                        style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input"
                                        id="trade_licence_{{$employeePersonal->id}}" name="trade_licence"
                                        style="display: none;" />
                                    <div id="trade_licence_file_{{$employeePersonal->id}}_name">
                                        <p
                                            style="width:100%; word-wrap:break-word; white-space:normal; font-size: 10px;">
                                            {{$trade_licenceName}}</p>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>VAT</label>
                                <label for="vat_{{$employeePersonal->id}}">
                                    @php
                                    ...
                                    <img src="{{ $vatPreview }}" alt="VAT"
                                        class="img-thumbnail" id="vat_file_{{$employeePersonal->id}}"
                                        style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input"
                                        id="vat_{{$employeePersonal->id}}" name="vat"
                                        style="display: none;" />
                                    <div id="vat_file_{{$employeePersonal->id}}_name">
                                        <p
                                            style="width:100%; word-wrap:break-word; white-space:normal; font-size: 10px;">
                                            {{$vatFileName}}</p>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>TAX</label>
                                <label for="tax_{{$employeePersonal->id}}">
                                    @php
                                    ...
                                    <img src="{{ $taxPreview }}" alt="TAX"
                                        class="img-thumbnail" id="tax_file_{{$employeePersonal->id}}"
                                        style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input"
                                        id="tax_{{$employeePersonal->id}}" name="tax"
                                        style="display: none;" />
                                    <div id="tax_file_{{$employeePersonal->id}}_name">
                                        <p
                                            style="width:100%; word-wrap:break-word; white-space:normal; font-size: 10px;">
                                            {{$taxFileName}}</p>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="gong_picture_{{$employeePersonal->id}}">
                                    @php
                                    ...
                                    <img src="{{ $gong_picturePreview }}" alt="gong_picture"
                                        class="img-thumbnail" id="gong_picture_file_{{$employeePersonal->id}}"
                                        style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input"
                                        id="gong_picture_{{$employeePersonal->id}}" name="gong_picture"
                                        style="display: none;" />
                                    <div id="gong_picture_file_{{$employeePersonal->id}}_name">
                                        <p
                                            style="width:100%; word-wrap:break-word; white-space:normal; font-size: 10px;">
                            ...
                            <div class="form-group">
                                ...
                                <label for="profile_picture_{{$employeePersonal->id}}">
                                    <img src="{{ asset('admin') }}/assets/img/fileupload.png" alt="Profile Picture"
                                        class="img-thumbnail" id="profile_picture_file_{{$employeePersonal->id}}"
                                        style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input"
                                        id="profile_picture_{{$employeePersonal->id}}" name="profile_picture"
                                        style="display: none;" />
                                    <div id="profile_picture_file_{{$employeePersonal->id}}_name"></div>
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="signature_{{$employeePersonal->id}}">
                                    <img src="{{ asset('admin') }}/assets/img/fileupload.png" alt="Signature"
                                        class="img-thumbnail" id="signature_file_{{$employeePersonal->id}}"
                                        style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input"
                                        id="signature_{{$employeePersonal->id}}" name="signature" style="display: none;" />
                                    <div id="signature_file_{{$employeePersonal->id}}_name"></div>
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="nid_card_front_{{$employeePersonal->id}}">
                                    <img src="{{ asset('admin') }}/assets/img/fileupload.png" alt="NID Card"
                                        class="img-thumbnail" id="nid_card_front_file_{{$employeePersonal->id}}"
                                        style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input" id="nid_card_front_{{$employeePersonal->id}}"
                                        name="nid_card_front" style="display: none;" />
                                    <div id="nid_card_front_file_{{$employeePersonal->id}}_name"></div>
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="nid_card_back_{{$employeePersonal->id}}">
                                    <img src="{{ asset('admin') }}/assets/img/fileupload.png" alt="NID Card"
                                        class="img-thumbnail" id="nid_card_back_file_{{$employeePersonal->id}}"
                                        style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input" id="nid_card_back_{{$employeePersonal->id}}"
                                        name="nid_card_back" style="display: none;" />
                                    <div id="nid_card_back_file_{{$employeePersonal->id}}_name"></div>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <label for="cv_{{$employeePersonal->id}}">
                                    <img src="{{ asset('admin') }}/assets/img/fileupload.png" alt="cv"
                                        class="img-thumbnail" id="cv_file_{{$employeePersonal->id}}"
                                        style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input" id="cv_{{$employeePersonal->id}}"
                                        name="cv" style="display: none;" />
                                    <div id="cv_file_{{$employeePersonal->id}}_name"></div>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <label for="trade_licence_{{$employeePersonal->id}}">
                                    ...
                                    <input type="file" class="form-control custom-input"
                                        id="trade_licence_{{$employeePersonal->id}}" name="trade_licence"
                                        style="display: none;" />
                                    <div id="trade_licence_file_{{$employeePersonal->id}}_name"></div>
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="vat_{{$employeePersonal->id}}">
                                    ...
                                    <input type="file" class="form-control custom-input"
                                        id="vat_{{$employeePersonal->id}}" name="vat"
                                        style="display: none;" />
                                    <div id="vat_file_{{$employeePersonal->id}}_name"></div>
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="tax_{{$employeePersonal->id}}">
                                    <img src="{{ asset('admin') }}/assets/img/fileupload.png"
                                        ...
                                        id="tax_file_{{$employeePersonal->id}}" style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input"
                                        id="tax_{{$employeePersonal->id}}" name="tax"
                                        style="display: none;" />
                                    <div id="tax_file_{{$employeePersonal->id}}_name"></div>
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="gong_picture_{{$employeePersonal->id}}">
                                    <img src="{{ asset('admin') }}/assets/img/fileupload.png"
                                        ...
                                        id="gong_picture_file_{{$employeePersonal->id}}" style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input"
                                        id="gong_picture_{{$employeePersonal->id}}" name="gong_picture"
                                        style="display: none;" />
                                    <div id="gong_picture_file_{{$employeePersonal->id}}_name"></div>
                                </label>
                            </div>
                        </div>
                        @endif
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label for="other_documents_{{$employeePersonal->id}}">
                                    <img src="{{ asset('admin') }}/assets/img/fileupload.png" alt="Other's Documents"
                                        class="img-thumbnail" id="other_documents_{{$employeePersonal->id}}_file"
                                        style="cursor: pointer;" />
                                    <input type="file" class="form-control custom-input"
                                        id="other_documents_{{$employeePersonal->id}}" name="other_documents[]"
                                        style="display: none;" multiple />
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="row" id="other_documents_{{$employeePersonal->id}}_preview">
                    </div>
                    <div class="row">
                        @foreach ($employeeotherdocuments as $employeeotherdocument)
                        @if ($employeeotherdocument->employee_id == $employeePersonal->id)
                        @php
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#other_documents_{{$employeePersonal->id}}').on('change', function () {
            ...
            if (files && files.length > 0) {
                for (let i = 0; i < files.length; i++) {
                    ...
                    `;
                        $('#other_documents_{{$employeePersonal->id}}_preview').append(img);
                    };
        ...
        $('#other_documents_{{$employeePersonal->id}}_preview').on('click', '.remove-image', function (e) {
            e.preventDefault();
            ...
            $('#other_documents_{{$employeePersonal->id}}')[0].files = dt.files;
    ...
    $(document).ready(function () {
        ...
        $('#profile_picture_file_{{$employeePersonal->id}}').on('click', function () {
            handleImagePreview('#profile_picture_{{$employeePersonal->id}}',
                '#profile_picture_file_{{$employeePersonal->id}}',
                '#profile_picture_file_{{$employeePersonal->id}}_name');
        });

        $('#signature_file_{{$employeePersonal->id}}').on('click', function () {
            handleImagePreview('#signature_{{$employeePersonal->id}}', '#signature_file_{{$employeePersonal->id}}',
                '#signature_file_{{$employeePersonal->id}}_name');
        });

        $('#nid_card_front_file_{{$employeePersonal->id}}').on('click', function () {
            handleImagePreview('#nid_card_front_{{$employeePersonal->id}}', '#nid_card_front_file_{{$employeePersonal->id}}',
                '#nid_card_front_file_{{$employeePersonal->id}}_name');
        });
        $('#nid_card_back_file_{{$employeePersonal->id}}').on('click', function () {
            handleImagePreview('#nid_card_back_{{$employeePersonal->id}}', '#nid_card_back_file_{{$employeePersonal->id}}',
                '#nid_card_back_file_{{$employeePersonal->id}}_name');
        });


        $('#cv_file_{{$employeePersonal->id}}').on('click', function () {
            handleImagePreview('#cv_{{$employeePersonal->id}}', '#cv_file_{{$employeePersonal->id}}',
                '#cv_file_{{$employeePersonal->id}}_name');
        });

        $('#trade_licence_file_{{$employeePersonal->id}}').on('click', function () {
            handleImagePreview('#trade_licence_{{$employeePersonal->id}}',
                '#trade_licence_file_{{$employeePersonal->id}}',
                '#trade_licence_file_{{$employeePersonal->id}}_name');
        });

        $('#vat_file_{{$employeePersonal->id}}').on('click', function () {
            handleImagePreview('#vat_{{$employeePersonal->id}}',
                '#vat_file_{{$employeePersonal->id}}',
                '#vat_file_{{$employeePersonal->id}}_name');
        });

        $('#tax_file_{{$employeePersonal->id}}').on('click', function () {
            handleImagePreview('#tax_{{$employeePersonal->id}}',
                '#tax_file_{{$employeePersonal->id}}',
                '#tax_file_{{$employeePersonal->id}}_name');
        });

        $('#gong_picture_file_{{$employeePersonal->id}}').on('click', function () {
            handleImagePreview('#gong_picture_{{$employeePersonal->id}}',
                '#gong_picture_file_{{$employeePersonal->id}}',
                '#gong_picture_file_{{$employeePersonal->id}}_name');
        });
    });
