                    ...
                    <div class="card-header project-details-card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="project-details-card-header-title"><i
                                    class='bx bx-user-check bx-tada'></i>Employees Confirmation
                            </h4>
                            ...
                            <div class="col-sm-8">
                                <div class="card card-round">
                                    <div class="row  card-body showbox" style="display: none">
                                        <div class="d-flex align-items-center">
                                            <label for="switchButton" class="me-2"><span id="switchLabelLeft">Confirmation</span></label>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="switchButton">
                                            </div>
                                            <label for="switchButton" class="ms-2"><span id="switchLabelRight">Probation Extend</span></label>
                                        </div>
                                        <div id="confirmationForm" class="form-container">
                                            <h3>Confirmation Form</h3>
                                            <form method="POST" action="{{ route('employee.confirmation.store') }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    <input type="text" class="selected_employee_id" name="employee_id" style="display: none">
                                                    <input type="text" name="confirm_or_extend" value="1" style="display: none">
                                                    <div class="col-sm-4 ">
                                                        <div class="form-group">
                                                            <label for="confirmation_date">Confirmation Date<span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control datepicker"
                                                                name="confirmation_date" id="confirmation_date"
                                                                value="{{ old('confirmation_date') }}" required>
                                                            @error('confirmation_date') <span
                                        ...
                                        <div id="probationExtend" class="form-container">
                                            <h3>Probation Extend</h3>
                                            <form method="POST" action="{{ route('employee.confirmation.store') }}" enctype="multipart/form-data">
                                                @csrf
                                                <input type="text" class="selected_employee_id" name="employee_id" style="display: none">
                                                <input type="text" name="confirm_or_extend" value="0" style="display: none">
                                                <div class="col-sm-4 ">
                                                    <div class="form-group">
                                                        <label for="last_probation_date">Last Probation Date</label>
                                                        <input type="text" class="form-control"
                                                            name="last_probation_date" id="last_probation_date"
                                                            value="{{ old('last_probation_date') }}" disabled>
                                                        @error('last_probation_date') <span
                                                            class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        <span class="text-danger" id="countdown">10 days left</span>

                                                    </div>
                                                </div>
                                                <div class="col-sm-4 ">
                                                    <div class="form-group">
                                                        <label for="new_probation_date">New Probation Date <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control datepicker"
                                                            name="new_probation_date" id="new_probation_date"
                                                            value="{{ old('new_probation_date') }}" required>
                                                        @error('new_probation_date') <span
                                                            class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
...
<script>
    ...
    function loademployees(departmentId, branchId, employeeSelectId) {
        if (departmentId) {
            $.ajax({
                url: '/dashboard/employee/confirmation/employees/' + departmentId + '/' +
                    branchId,
                type: 'GET',
    ...
    $(document).ready(function () {
        $('#employee_id').on('change', function () {
            ...
            if (employeeId) {
                $.ajax({
                    url: '/dashboard/employee/confirmation/employees/' + employeeId,
                    type: 'GET',
                    success: function (data) {
                        console.log(data);
                        ...
                        let joiningDateString = data.pay_roll_information.joining_date;
