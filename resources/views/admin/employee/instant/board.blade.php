...
<div class="modal fade" id="boardModal" tabindex="-1" aria-hidden="true" role="dialog" >
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="project-details-card-header-title">
                    <i class="bx bx-user-pin bx-tada bx-flip-horizontal"></i> Create Board/University
                </h4>
                ...
                <form id="addboardForm">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="name" class="form-control custom-input" id="educationBoardName" placeholder="Board/University" required>
                    ...
                    <div class="col-lg-12">
                        <div class="hstack gap-2 justify-content-end py-3">
                            ...
                            <button type="button" id="saveboardBtn" class="submit-button-1">
