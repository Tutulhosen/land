                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="tab-content mt-3 mb-3" id="line-tabContent">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control custom-input custom-input customer_id" id="customer_id" placeholder="Customer ID" name="customer_id" value="{{$customers->code}}">
                                            </div>
                                       </div>
                                       ...
                                       <div class="col-sm-4">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control custom-input custom-input customer_name_en" id="customer_name_en" name="customer_name_en" value="{{$customers->name}}" placeholder="Type Customer Name English">
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-sm-4">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control custom-input custom-input customer_name_bn" id="customer_name_bn" name="customer_name_bn" value="{{$customers->name_bangla}}" placeholder="Type Customer Name Bangla">
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-sm-2">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control custom-input custom-input customer_id_old" id="customer_id_old" placeholder="Customer ID" value="{{$customers->old_code}}" name="customer_id_old">
                                          </div>
                                       </div>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <select class="form-select form-control customer_nation" id="customer_nation" name="customer_nation" placeholder="Expense Category">
                                                ...
                                                @foreach ($nationalities as $nationalitie)
                                                    <?php 
                                                        if ($nationalitie->id==$customers->nationality) {
                                                            $selected='selected';
                                                        } else {
                                                            $selected='';
                                                        }
                                                    ...
                                                    ?>
                                                    <option {{$selected}} value="{{$nationalitie->id}}">{{$nationalitie->name}}</option>
                                                @endforeach
                                             </select>
                                          </div>
                                       </div>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <select class="form-select form-control customer_blood" id="customer_blood" name="customer_blood" placeholder="Expense Category">
                                                ...
                                                @foreach ($bloodgroups as $bloodgroup)
                                                    <?php 
                                                        if ($bloodgroup->id==$customers->blood_id) {
                                                            $selected='selected';
                                                        } else {
                                                            $selected='';
                                                        }
                                       ...
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control custom-input custom-input customer_father_en" id="customer_father_en" value="{{$customers->father_name}}" name="customer_father_en" placeholder="Type Customer Father's Name in English">
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control custom-input custom-input customer_father_bn" id="customer_father_bn" value="{{$customers->father_name_bangla}}" name="customer_father_bn" placeholder="Type Customer Father's Name in Bangla">
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control custom-input custom-input customer_mother_en" id="customer_mother_en" value="{{$customers->mother_name}}" name="customer_mother_en" placeholder="Type Customer Mother's Name in English">
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control custom-input custom-input customer_mother_bn" id="customer_mother_bn" value="{{$customers->mother_name_bangla}}" name="customer_mother_bn" placeholder="Type Customer Mother's Name in Bangla">
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-sm-4">
                                          <div class="form-group">
                                             ...
                                             <input type="date" class="form-control custom-input custom-input customer_dob" id="customer_dob" name="customer_dob" value="{{$customers->dob}}" placeholder="Expense Date">
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-sm-2">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control custom-input custom-input customer_age" id="customer_age" name="customer_age" value="{{$customers->age}}" placeholder="Current Age">
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-sm-2">
                                          <div class="form-group">
                                             ...
                                             <select class="form-select form-control customer_id_type" id="customer_id_type" name="customer_id_type" placeholder="Expense Category">
                                                ...
                                                <option value="Passport" {{ $customers->id_type == 'Passport' ? 'selected' : '' }}>Passport</option>
                                                <option value="Nid_card" {{ $customers->id_type == 'Nid_card' ? 'selected' : '' }}>NID Card</option>
                                                <option value="Nid_smart_card" {{ $customers->id_type == 'Nid_smart_card' ? 'selected' : '' }}>NID Smart Card</option>
                                                <option value="Birth_registration" {{ $customers->id_type == 'Birth_registration' ? 'selected' : '' }}>Birth Registration</option>
                                                <option value="Driving_licence" {{ $customers->id_type == 'Driving_licence' ? 'selected' : '' }}>Driving Licence</option>
                                       ...
                                       <div class="col-sm-4">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control custom-input custom-input customer_id_number" id="customer_id_number" name="customer_id_number" value="{{$customers->nid_no}}" placeholder="Type Customer ID Number">
                                          </div>
                                       </div>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <select class="form-select form-control customer_religion" id="customer_religion" name="customer_religion" placeholder="Expense Category">
                                                ...
                                                @foreach ($religions as $religion)
                                                    <?php 
                                                        if ($religion->id==$customers->religion) {
                                                            $selected='selected';
                                                        } else {
                                                            $selected='';
                                                        }
                                       ...
                                       <div class="col-sm-4">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control custom-input custom-input customer_profession" id="customer_profession" value="{{$customers->occupation}}" name="customer_profession" placeholder="Type Customer Profession">
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-sm-4">
                                          <div class="form-group">
                                             ...
                                             <select class="form-select form-control customer_salesman_name" name="customer_salesman_name" id="customer_salesman_name" placeholder="Expense Category">
                                                <option value="{{$customers->salesman}}"> {{$customers->get_salesman->salesman_name ?? null}} </option>
                                       ...
                                       <div class="col-sm-4">
                                        <div class="form-group">
                                           ...
                                           <select class="form-select form-control customer_login_access" name="customer_login_access" id="customer_login_access" placeholder="Expense Category">
                                              <option>--Select--</option>
                                              <option {{ $customers->customer_login_access == 'Yes' ? 'selected' : '' }} value="Yes">Yes</option>
                                              <option {{ $customers->customer_login_access == 'No' ? 'selected' : '' }} value="No">No</option>
                                           </select>
                                        </div>
                                     </div>
                                    ...
                                    <div class="row">
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control custom-input custom-input customer_phone" id="customer_phone" value="{{$customers->number}}" name="customer_phone" placeholder="Type Valid Mobile Number">
                                            </div>
                                         </div>
                                         ...
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control custom-input custom-input customer_email" id="customer_email" name="customer_email" value="{{$customers->email}}" placeholder="Type Valid Email Address">
                                            </div>
                                         </div>
                                               ...
                                               <select class="form-select form-control customer_div_pre" id="customer_div_pre" name="customer_div_pre" placeholder="Expense Category">
                                                  <option>-Select-</option>
                                                    @foreach ($divisions as $division)
                                                        <?php 
                                                            if ($division->id==$customers->customer_div_pre) {
                                                                $selected='selected';
                                                            } else {
                                                                $selected='';
                                                            }
                                         ...
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                               ...
                                               <select class="form-select form-control customer_dis_pre" id="customer_dis_pre" name="customer_dis_pre" placeholder="Expense Category">
                                                  <option value="{{$customers->customer_dis_pre}}">{{dis_id_to_name($customers->customer_dis_pre)}}</option>
                                         ...
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                               ...
                                               <select class="form-select form-control customer_upa_pre" id="customer_upa_pre" name="customer_upa_pre" placeholder="Expense Category">
                                                  <option value="{{$customers->customer_upa_pre}}">{{upa_id_to_name($customers->customer_upa_pre)}}</option>
                                         ...
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control customer_union_pre" name="customer_union_pre" id="customer_union_pre" value="{{$customers->customer_union_pre}}" placeholder="Word/Union">
                                         ...
                                         <div class="col-sm-7">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control customer_add_pre" id="customer_add_pre" name="customer_add_pre" value="{{$customers->customer_add_pre}}" placeholder="Type Full Address">
                                            </div>
                                         </div>
                                         ...
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control customer_post_off_pre" id="customer_post_off_pre" name="customer_post_off_pre" value="{{$customers->customer_post_off_pre}}" placeholder="Type Post Office Name">
                                            </div>
                                         </div>
                                         ...
                                         <div class="col-sm-2">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control customer_post_code_pre" id="customer_post_code_pre" name="customer_post_code_pre" value="{{$customers->customer_post_code_pre}}" placeholder="Type Post Code">
                                            </div>
                                         </div>
                                         ...
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                               ...
                                               <select class="form-select form-control customer_div_per" id="customer_div_per" name="customer_div_per" placeholder="Expense Category">
                                                  ...
                                                  @foreach ($divisions as $division)
                                                    <?php 
                                                            if ($division->id==$customers->customer_div_per) {
                                                                $selected='selected';
                                                            } else {
                                                                $selected='';
                                                            }
                                         ...
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                               ...
                                               <select class="form-select form-control customer_dis_per" id="customer_dis_per" name="customer_dis_per" placeholder="Expense Category">
                                                  <option value="{{$customers->customer_dis_per}}">{{dis_id_to_name($customers->customer_dis_per)}}</option>
                                         ...
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                               ...
                                               <select class="form-select form-control customer_upa_per" id="customer_upa_per" name="customer_upa_per" placeholder="Expense Category">
                                                  <option value="{{$customers->customer_upa_per}}">{{upa_id_to_name($customers->customer_upa_per)}}</option>
                                         ...
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control customer_union_per" name="customer_union_pers" id="customer_union_per" value="{{$customers->customer_union_pers}}" placeholder="Word/Union">
                                         ...
                                         <div class="col-sm-7">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control customer_add_per" name="customer_add_per" id="customer_add_per" value="{{$customers->permanent_address}}" placeholder="Type Full Address">
                                            </div>
                                         </div>
                                         ...
                                         <div class="col-sm-3">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control customer_post_off_per" id="customer_post_off_per" name="customer_post_off_per" value="{{$customers->customer_post_off_per}}" placeholder="Type Post Office Name">
                                            </div>
                                         </div>
                                         ...
                                         <div class="col-sm-2">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control customer_post_code_per" id="customer_post_code_per" name="customer_post_code_per" value="{{$customers->customer_post_code_per}}" placeholder="Type Post Code">
                                            </div>
                                         </div>
                                ...
                                <!--Nominee -->
                                <div class="tab-pane fade" id="line-granter" role="tabpanel" aria-labelledby="line-granter-tab">
                                    <div id="granterFormContainer"></div>
                                    <button id="addgranterFormBtn" class="btn btn-primary" type="button">+Add
                                        Nominee</button>
                                        @foreach ($customers->nominees as $nominee)
                                            <div class="soft-bg-3 row border rounded p-3">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nominee_name">Nominee Name</label>
                                                        <input type="text" class="form-control" id="nominee_name" name="nominee_name[]" placeholder="Type Nominee Full Name" value="{{$nominee->name}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select form-control" name="nominee_relation[]" id="nominee_relation" placeholder="Expense Category">
                                                            ...
                                                            @foreach ($relations as $relation)
                                                                <?php 
                                                                    if ($relation->id==$nominee->relationship) {
                                                                        $selected='selected';
                                                                    } else {
                                                                        $selected='';
                                                                    }
                                                                ...
                                                                ?>
                                                                <option {{$selected}} value="{{$relation->id}}">{{$relation->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nominee_phone" name="nominee_phone[]" placeholder="Type Valid Phone Number" value="{{$nominee->contact_number}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="nominee_pre_add">Nominee Present Address</label>
                                                        <input type="text" class="form-control" id="nominee_pre_add" name="nominee_pre_add[]" placeholder="Type Full Present Address" value="{{$nominee->present_address}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="nominee_per_add">Nominee Permanent Address</label>
                                                        <input type="text" class="form-control" id="nominee_per_add" name="nominee_per_add[]" placeholder="Type Full Permanent Address" value="{{$nominee->permanent_address}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nominee_email">Nominee Email Address</label>
                                                        <input type="text" class="form-control" id="nominee_email" name="nominee_email[]" placeholder="Type Valid Email ID" value="{{$nominee->mailing_address}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nominee_share">Share (%) Persent</label>
                                                        <input type="number" class="form-control" id="nominee_share" name="nominee_share[]" placeholder="Type %" value="{{$nominee->share}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select form-control" id="nominee_id_type" name="nominee_id_type[]" placeholder="Expense Category">
                                                            <option>-Select-</option>
                                                            <option {{ $nominee->nominee_id_type == 'Passport' ? 'selected' : '' }} value="Passport">Passport</option>
                                                            <option {{ $nominee->nominee_id_type == 'Nid_card' ? 'selected' : '' }} value="Nid_card">NID Card</option>
                                                            <option {{ $nominee->nominee_id_type == 'Nid_smart_card' ? 'selected' : '' }} value="Nid_smart_card">NID Smart Card</option>
                                                            <option {{ $nominee->nominee_id_type == 'Birth_registration' ? 'selected' : '' }} value="Birth_registration">Birth Registration</option>
                                                            <option {{ $nominee->nominee_id_type == 'Driving_licence' ? 'selected' : '' }} value="Driving_licence">Driving Licence</option>
                                                        </select> 
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$nominee->nominee_id}}" class="form-control" id="nominee_id" name="nominee_id[]" placeholder="Type Valid ID Number">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="line-reference" role="tabpanel"
                                    ...
                                    @foreach ($customers->gong as $gongs)
                                        <div class="soft-bg-3 row border rounded p-3">
                
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="gong_name">Gong Name</label>
                                                    <input type="text" class="form-control" value="{{$gongs->gong_name}}" id="gong_name" name="gong_name[]" placeholder="Type Gong Full Name">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select form-control" id="gong_relation" name="gong_relation[]" placeholder="Expense Category">
                                                        ...
                                                        @foreach ($relations as $relation)
                                                            <?php 
                                                                if ($relation->id==$gongs->gong_relationship) {
                                                                    $selected='selected';
                                                                } else {
                                                                    $selected='';
                                                                }
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$gongs->gong_contact_number}}" class="form-control" id="gong_phone" name="gong_phone[]" placeholder="Type Valid Phone Number">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="gong_pre_add">Gong Present Address</label>
                                                    <input type="text" value="{{$gongs->present_address}}" class="form-control" id="gong_pre_add" name="gong_pre_add[]" placeholder="Type Full Present Address">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="gong_per_add">Gong Permanent Address</label>
                                                    <input type="text" value="{{$gongs->gong_address}}" class="form-control" id="gong_per_add" name="gong_per_add[]" placeholder="Type Full Permanent Address">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="gong_email">Gong Email Address</label>
                                                    <input type="text" value="{{$gongs->mailing_address}}" class="form-control" id="gong_email" name="gong_email[]" placeholder="Type Valid Email ID">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="gong_share">Share (%) Persent</label>
                                                    <input type="number" value="{{$gongs->share}}" class="form-control" id="gong_share" name="gong_share[]" placeholder="Type %">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select form-control" id="gong_id_type" name="gong_id_type[]" placeholder="Expense Category">
                                                        <option>-Select-</option>
                                                        <option {{ $gongs->gong_id_type == 'Passport' ? 'selected' : '' }} value="Passport">Passport</option>
                                                        <option {{ $gongs->gong_id_type == 'Nid_card' ? 'selected' : '' }} value="Nid_card">NID Card</option>
                                                        <option {{ $gongs->gong_id_type == 'Nid_smart_card' ? 'selected' : '' }} value="Nid_smart_card">NID Smart Card</option>
                                                        <option {{ $gongs->gong_id_type == 'Birth_registration' ? 'selected' : '' }} value="Birth_registration">Birth Registration</option>
                                                        <option {{ $gongs->gong_id_type == 'Driving_licence' ? 'selected' : '' }} value="Driving_licence">Driving Licence</option>
                                                    </select> 
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$gongs->gong_id}}" class="form-control" id="gong_id" name="gong_id[]" placeholder="Type Valid ID Number">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
