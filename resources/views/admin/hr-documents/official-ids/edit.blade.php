                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control custom-input" id="salutation"
                                                    ...
                                                    <option value="{{$salutation->id}}"
                                                        {{ $employee->salutation == $salutation->id ? 'selected' :''}}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control" id="gender" name="gender">
                                                    ...
                                                    <option value="{{$genders->id}}"
                                                        {{ $employee->gender == $genders->id ? 'selected' : '' }}>
                                                        {{$genders->name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control" id="nationality"
                                                    ...
                                                    @foreach ($nationalities as $nationalitys)
                                                    <option value="{{$nationalitys->id}}"
                                                        {{ $employee->nationality == $nationalitys->id ? 'selected' : '' }}>
                                                        {{$nationalitys->name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control" id="blood_group"
                                                    ...
                                                    @foreach ($bloodgroups as $bloodgroupone)
                                                    <option value="{{$bloodgroupone->id}}"
                                                        {{ $employee->blood_group== $bloodgroupone->id ? 'selected' : '' }}>
                                                        {{ $bloodgroupone->name}} </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control" id="probation_period"
                                                    ...
                                                    <option value="{{$probationPeriod->id}}"
                                                        {{ $employee->probation_period== $probationPeriod->id ? 'selected' : '' }}>
                                                        {{$probationPeriod->name}} </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control" id="reporting_to"
                                                    ...
                                                    @foreach ($employeeinfos as $employeeinfo)
                                                        <option value="{{$employeeinfo->id}}" {{ $employee->reporting_to==$employeeinfo->id? 'selected' : '' }}>{{$employeeinfo->salutations ? $employeeinfo->salutations->name :''}} {{$employeeinfo->first_name}} {{$employeeinfo->last_name}}</option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="tab-pane fade" id="line-education" role="tabpanel"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select form-control" name="education_type[]">
                                                        ...
                                                        <option value="{{$educationtype->id}}"
                                                            {{ $education->education_type == $educationtype->id ? 'selected' : '' }}>
                                                            {{$educationtype->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select form-control" name="education[]">
                                                        ...
                                                        @foreach ($educationsonly as $educationonly)
                                                        <option value="{{$educationonly->id}}"
                                                            {{ $education->education == $educationonly->id ? 'selected' : '' }}>
                                                            {{$educationonly->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="result[]"
                                                        value="{{ $education->result_university }}"
                                                        placeholder="Result">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <script>
                                        ...
                                        function createNewFormSection() {
                                            ...
                                            formSection.classList.add('soft-bg-3', 'row', 'border', 'rounded', 'p-3',
                                                'mb-3');
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select form-control" name="education[]">
                                                            <option  selected disabled>Select Education</option>
                                                            @foreach ($educationsonly as $educationonly)
                                                                <option value="{{$educationonly->id}}">{{$educationonly->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="soft-bg-3 row border rounded p-3 mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="job_respons[]"
                                                        value="{{$experience->job_respons}}"
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control"
                                                        value="{{ $experience->from_date }}" name="from_date[]">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control"
                                                        value="{{ $experience->to_date }}" name="to_date[]">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                        ...
                                        <div class="soft-bg-3 row border rounded p-3 mb-3">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="train_type[]"
                                                        value="{{$training->train_type}}" placeholder="Training Type">
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="course_title[]"
                                                        value="{{$training->course_title}}" placeholder="Course Title">
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="course_duration">Course Duration</label>
                                                    <input type="text" class="form-control" name="course_duration[]" placeholder="Course Duration (In Month)" value="{{$training->course_duration}}">
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="6" name="description[]"
                                                        placeholder="Write Here">{{$training->description}}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="year[]"
                                                        placeholder="Year" value="{{ $training->year }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="course_result[]"
                                                        placeholder="course result" value="{{ $training->result }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group"><label for="institute_address">Institute
                                                        Address</label>
                                                    <input type="text" class="form-control" name="institute_address[]"
                                                        placeholder="Institute Address"
                                                        value="{{ $training->institute_address }}">
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control" id="relation" name="relation"
                                                    ...
                                                    @foreach ($relations as $relationselect)
                                                        <option value="{{$relationselect->id}}" {{ $emergencyContact->relation== $relationselect->id ? 'selected' : '' }}>{{$relationselect->name}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control mb-3"
                                                    ...
                                                    <option value="{{ $week_off->id }}" {{$officialInformation->holiday_id == $week_off->id ? 'selected' : '' }}>{{ $week_off->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control mb-3"
                                                    ...
                                                    <option value="{{ $shift->id }}" {{$officialInformation->shift_id == $shift->id ? 'selected' : '' }}>
                                                        {{ $shift->shift_name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control" id="edit_salary_type"
                                                    name="salary_type" onchange="toggleEditBank()">
...
<script>
    function toggleEditBank() {
        const salaryType = document.getElementById("edit_salary_type").value; // Get the selected value
