               ...
               <div class="card">
                    <div class="card-header project-details-card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="project-details-card-header-title"><i class='bx bx-edit bx-tada' ></i> Branch Information</h4>
                            @can('Create Branch')
                            <a href="#" class="purchase-button ms-auto" data-bs-toggle="modal" data-bs-target="#exampleModalgrid-leads">
                            <i class='bx bx-message-square-add bx-tada' ></i> Add Branch</a>
                            @endcan
           ...
           <div class="card">
              ...
              <div class="card-body">
                <div class="nav flex-column nav-pills nav-secondary nav-pills-no-bd" id="v-pills-tab-without-border" role="tablist" aria-orientation="vertical">
                    <a class="nav-link {{ session('activeTab') == 'regional_office' || !session('activeTab') ? 'active' : '' }}" id="project-type-tab-nobd" data-bs-toggle="pill" href="#project-type-nobd" role="tab" aria-controls="project-type-nobd" aria-selected="false" tabindex="-1">Regional Office</a>
                    <a class="nav-link {{ session('activeTab') == 'zonal_office' ? 'active' : '' }}" id="product-category-tab-nobd" data-bs-toggle="pill" href="#product-category-nobd" role="tab" aria-controls="product-category-nobd" aria-selected="true">Zonal Office</a>
                    <a class="nav-link {{ session('activeTab') == 'area_office' ? 'active' : '' }}" id="industry-type-tab-nobd" data-bs-toggle="pill" href="#industry-type-nobd" role="tab" aria-controls="industry-type-nobd" aria-selected="false" tabindex="-1">Area Office</a>
                    <a class="nav-link {{ session('activeTab') == 'branch_office' ? 'active' : '' }}" id="client-type-tab-nobd" data-bs-toggle="pill" href="#client-type-nobd" role="tab" aria-controls="client-type-nobd" aria-selected="false" tabindex="-1">Branch Office</a>
                    <a class="nav-link {{ session('activeTab') == 'liaison_office' ? 'active' : '' }}" id="liaison-type-tab-nobd" data-bs-toggle="pill" href="#liaison-type-nobd" role="tab" aria-controls="liaison-type-nobd" aria-selected="false" tabindex="-1">Liaison Office</a>
                </div>
              </div>
           </div>
        </div>
                                   ...
                                   <table id="add-row" class="display table table-striped table-hover basic-datatables" role="grid" aria-describedby="add-row_info">
                                      <thead class="">
                                         <tr role="row">
                                            ...
                                            <th class="text-center w-20">Regional Office</th>
                                            <th class="text-start">Official Info</th>
                                            <th class="text-center">Contact</th>
                                            <th class="text-start">Zonal Office</th>
                                      ...
                                      <tbody>
                                        ...
                                        @foreach($branches as $index => $branch)
                                            @if($branch->type == 'regional_office') <!-- Check for branch_office type -->
                                                <tr>
                                                    ...
                                                    <td class="text-start">
                                                        <ul>
                                                            @foreach($branch->assignedOffices as $zonalBranch)
                                                                <li>
                                                                    {{ $zonalBranch->name }}
                                                                    <a href="#" class="delete-assigned-branch-link text-danger float-end"
                                                                        data-assigned-branch-id="{{ $zonalBranch->id }}">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="form-button-action">
                                                            ...
                                                            @can('Update Branch')
                                                            <button class="btn btn-success btn-link btn-lg" data-bs-toggle="modal" data-bs-target="#zone_assign_modal-{{ $branch->id }}">
