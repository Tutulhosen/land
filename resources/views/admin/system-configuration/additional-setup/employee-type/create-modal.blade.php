<div class="modal fade bs-example-modal-center" id="Modal-employee-type" tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
       <div class="modal-content">
          <div class="modal-header">
             <h4 class="employee-details-card-header-title"><i class="bx bx-employee-pin bx-tada bx-flip-horizontal"></i>Add Employee Type</h4>
