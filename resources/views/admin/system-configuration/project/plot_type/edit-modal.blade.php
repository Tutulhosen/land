<div class="modal fade bs-example-modal-center" id="editModalgrid-plot_type-{{ $plot_type->id }}" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
       <div class="modal-content">
          ...
          <div class="modal-body px-5">
            <form action="{{ route('plot_type.update', $plot_type->id) }}" method="POST" enctype="multipart/form-data">
               @csrf
               @method('PUT')
                <div class="row">
                  ...
                  <div class="col-lg-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control custom-input" value="{{$plot_type->name}}" id="name" placeholder="Name" required>
