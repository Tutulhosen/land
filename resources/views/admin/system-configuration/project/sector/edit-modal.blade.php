<div class="modal fade bs-example-modal-center" id="editModalgrid-branch-{{ $sector->id }}" tabindex="-1"
   aria-labelledby="editModalgridLabel" style="display: none;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
       <div class="modal-content">
          <div class="modal-header">
             <h4 class="project-details-card-header-title"><i class="bx bx-user-pin bx-tada bx-flip-horizontal"></i>Edit Sector</h4>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                           ...
                           <select class="form-control" name="project" id="project" required>
                              ...
                              @foreach ($projects as $project)
                                 <?php 
                                    if ($project->id==$sector->project_id) {
                                       $selected= 'selected';
                                    } else {
                                       $selected= ' ';
                                    }
                   ...
                   <div class="col-lg-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="sector_name" class="form-control custom-input" id="sector_name" placeholder="Sector Name" value="{{$sector->sector_name}}" required>
