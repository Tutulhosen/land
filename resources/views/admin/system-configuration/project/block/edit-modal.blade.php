<div class="modal fade bs-example-modal-center" id="editModalgrid-block-{{ $block->id }}" tabindex="-1"
   aria-labelledby="editModalgridLabel" style="display: none;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
       <div class="modal-content">
          <div class="modal-header">
             <h4 class="project-details-card-header-title"><i class="bx bx-user-pin bx-tada bx-flip-horizontal"></i>Edit Block</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="block_name" class="form-control custom-input" value="{{$block->block_name}}" id="block_name" placeholder="Sector Name" required>
