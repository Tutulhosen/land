...
return new class extends Migration
{
    ...
    {
        Schema::create('employee_confirm_or_extends', function (Blueprint $table) {
            $table->id();
            $table->foreignId('employee_id')->constrained('employee_personal_information')->onDelete('cascade');
            $table->string('confirm_or_extend')->nullable();
            ...
            $table->date('old_probation_date')->nullable();
            $table->date('new_probation_date')->nullable();
    ...
    {
        Schema::dropIfExists('employee_confirm_or_extends');
    }
};
